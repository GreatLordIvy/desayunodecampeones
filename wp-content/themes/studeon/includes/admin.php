...
if ( !function_exists( 'studeon_admin_notice' ) ) {
	//Handler of the add_action('admin_notices', 'studeon_admin_notice', 2);
...
if ( !function_exists( 'studeon_callback_hide_admin_notice' ) ) {
	//Handler of the add_action('wp_ajax_studeon_hide_admin_notice', 'studeon_callback_hide_admin_notice');
...
if ( !function_exists( 'studeon_admin_footer' ) ) {
	//Handler of the add_action('admin_footer', 'studeon_admin_footer');
...
if ( !function_exists( 'studeon_admin_scripts' ) ) {
	//Handler of the add_action("admin_enqueue_scripts", 'studeon_admin_scripts');
...
if ( !function_exists( 'studeon_admin_localize_scripts' ) ) {
	//Handler of the add_action("admin_footer", 'studeon_admin_localize_scripts');
