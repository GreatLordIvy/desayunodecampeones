...
if ( !function_exists( 'studeon_essential_grid_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('studeon_filter_tgmpa_required_plugins',	'studeon_essential_grid_tgmpa_required_plugins');
...
if ( !function_exists( 'studeon_essential_grid_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'studeon_essential_grid_frontend_scripts', 1100 );
...
if ( !function_exists( 'studeon_essential_grid_merge_styles' ) ) {
	//Handler of the add_filter('studeon_filter_merge_styles', 'studeon_essential_grid_merge_styles');
