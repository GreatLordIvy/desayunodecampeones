...
if ( !function_exists( 'studeon_wp_scripts' ) ) {
	//Handler of the add_action('wp_enqueue_scripts', 'studeon_wp_scripts', 1000);
...
if ( !function_exists( 'studeon_localize_scripts' ) ) {
	//Handler of the add_action('wp_footer', 'studeon_localize_scripts');
...
if ( !function_exists( 'studeon_wp_scripts_responsive' ) ) {
	//Handler of the add_action('wp_enqueue_scripts', 'studeon_wp_scripts_responsive', 2000);
...
if (!function_exists('studeon_wp_head')) {
	//Handler of the add_action('wp_head',	'studeon_wp_head', 1);
...
if ( !function_exists('studeon_add_body_classes') ) {
	//Handler of the add_filter( 'body_class', 'studeon_add_body_classes' );
...
if ( !function_exists( 'studeon_wp_footer' ) ) {
	//Handler of the add_action('wp_footer', 'studeon_wp_footer');
...
if ( !function_exists('studeon_register_sidebars') ) {
	// Handler of the add_action('widgets_init', 'studeon_register_sidebars');
...
if ( !function_exists( 'studeon_importer_set_options' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_importer_options',	'studeon_importer_set_options', 9 );
	function studeon_importer_set_options($options=array()) {
		if (is_array($options)) {
			...
			$options['files']['default']['domain_dev'] = esc_url(studeon_get_protocol().'://studeon.dev');		// Developers domain
			$options['files']['default']['domain_demo']= esc_url(studeon_get_protocol().'://studeon.axiomthemes.com');		// Demo-site domain
		}
		return $options;
	}
}
