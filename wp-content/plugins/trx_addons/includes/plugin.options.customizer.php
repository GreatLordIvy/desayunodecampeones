...
if ( !function_exists('trx_addons_options_show_field') ) {
	function trx_addons_options_show_field($name, $field) {
		...
		// Type 'image'
			...
			$output .= '<input type="text" id="trx_addons_options_field_'.esc_attr($name).'"'
							. ' name="trx_addons_options_field_'.esc_attr($name).'"'
							. ' value="'.esc_attr($field['val']).'"'
							. ' />'
						. trx_addons_options_show_custom_field('trx_addons_options_field_'.esc_attr($name).'_button', 
								array(
									'type'=>'mediamanager',
									'linked_field_id'=>'trx_addons_options_field_'.esc_attr($name)
									),
								null)
		...
		// Type 'googlemap'
			...
			$output .= '<input type="hidden" id="trx_addons_options_field_'.esc_attr($name).'"'
							. ' name="trx_addons_options_field_'.esc_attr($name).'"'
							. ' value="'.esc_attr($field['val']).'"'
							. ' />'
