...
if (!function_exists('trx_addons_sc_services_add_in_vc_params')) {
	function trx_addons_sc_services_add_in_vc_params() {
		$params = array_merge(
				array(
					...
					array(
						...
						'dependency' => array(
							'element' => 'type',
							'value' => array('default', 'light', 'alter', 'list', 'iconed', 'tabs_simple')
						),
						"std" => "top",
				        'save_always' => true,
						"value" => array(
					...
					array(
						...
						'dependency' => array(
							'element' => 'type',
							'value' => array('default', 'light', 'alter', 'list', 'iconed', 'tabs', 'tabs_simple')
						),
						"std" => "0",
		...
		$params = trx_addons_vc_add_param_option($params, 'columns', array( 
																		'dependency' => array(
																			'element' => 'type',
																			'value' => array('default', 'light', 'alter', 'list', 'iconed', 'hover')
																			)
																		)
												);
